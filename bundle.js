...
var boat_model_1 = require("./models/boat.model");
var parachutist_model_1 = require("./models/parachutist.model");
var Game = (function () {
    function Game(canvasId) {
        ...
        this.boat = new boat_model_1.Boat(this.canvas.width / 2 - 40, this.canvas.height - 50);
        this.parachutists = [];
        this.score = 0;
        this.lives = 3;
    ...
    Game.prototype.spawnParachutist = function () {
        ...
        var parachutist = new parachutist_model_1.Parachutist(x, 50);
...
},{"./models/boat.model":2,"./models/parachutist.model":3}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Boat = void 0;
var Boat = (function () {
